			...
			metaInfo() {
				...
				return {
					...
					meta: [ 
						...
						{ property: 'og:image', 			content: this.$t('aws.bucket') + 'digital-x-sc-general-terms-and-conditions.jpg' },
						...
						{ property: 'twitter:image', 		content: this.$t('aws.bucket') + 'digital-x-sc-general-terms-and-conditions.jpg' }
					],
					link: [	this.canonical ]
				};
			},
