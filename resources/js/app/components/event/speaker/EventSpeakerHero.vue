<template>
  <div class="event-speaker-hero">
    <!-- IMAGE -->
    <div class="event-speaker-hero__image" :style="imageGradient">
      <section class="inner no-spacing">
        <div class="col-100">
          <div class="event-speaker-hero__container">
            <div class="event-speaker-hero__content">
              <div v-if="subtitle" class="event-speaker-hero__subtitle">
                {{ subtitle }}
                <span v-if="subtitleTag">{{ subtitleTag }}</span>
              </div>
              <div class="event-speaker-hero__title">
                {{ title }}
              </div>
              <p v-if="text" class="event-speaker-hero__text" v-html="text"/>
            </div>
          </div>
        </div>
      </section>
